  ...
  <div class="repository-list-item">
    ...
    <div class="content">
      <div class="title">
        ...
        <span>/</span>
        <span>{{ content.repositoryName }}</span>
      ...
      <div class="description" v-html="content.descriptionHTML">
      </div>
      <div class="tag-list">
...
import { StarIcon, CommentIcon, KnowledgeIcon } from '../../icons';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const content = computed(() => (repository.value.content as KnowledgeModelType))
    return {
      content
    }
  }
